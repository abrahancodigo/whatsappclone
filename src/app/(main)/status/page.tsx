      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="mb-4">
          ...
          {userStatuses.length > 0 ? (
            ...
            <div className="rounded-lg border border-dashed border-[var(--color-border-wa)] bg-[var(--color-bg-panel)] p-6 text-center">
              <p className="text-sm text-[var(--color-tx-secondary)]">Agrega un estado para compartir con tus contactos</p>
            </div>
          )}
        </div>
