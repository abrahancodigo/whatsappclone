...
const Card = React.forwardRef(function Card(
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "rounded-lg border border-[var(--color-border-wa)] bg-[var(--color-bg-panel)] text-[var(--color-tx-primary)] shadow-sm",
        className
      )}
      {...props}
    />
...
const CardDescription = React.forwardRef(function CardDescription(
  ...
  return <p ref={ref} className={cn("text-sm text-[var(--color-tx-secondary)]", className)} {...props} />;
});
